  ...
  <div className="content-container">
    <Features>
      ...
      <Feature>
        ...
        <p>Name your page files with locales suffixed, Nextra and Next.js will do the rest for you.<br/><File name="/hello.en-US.mdx"/><br/><File name="/hello.de-DE.mdx"/><br/><File name="/hello.ja-JP.mdx"/></p>
      </Feature>
      ...
      <Feature>
        ...
        <Comparison a={
          <div style={{ fontSize: '.9rem', lineHeight: 2 }}>
            ...
            <br/>
            <span>{`![Example](../public/example.png)`}</span>
          </div>
        } b={
          <div style={{ fontSize: '.9rem', lineHeight: 2 }}>
            <span>{`<Link .../>`}</span>
