    ...
    <div className="content-container">
      <Features>
        ...
        <Feature centered style={{
          ...
          }}><a href="https://mdxjs.com/blog/v2" target="_blank" style={{ color: 'currentColor' }}>MDX 2</a> lets you use Components inside Markdown, <br/>with huge performance boost since MDX v1.</p>
        </Feature>
        <Feature centered className="darkmode-container" style={{
          display: 'flex',
          alignItems: 'center',
          justifyContent: 'center',
          ...
          >
            <motion.div style={{
              ...
              width: '100%',
              height: '100%',
              boxShadow: '0 -10px 40px inset rgba(0,0,0,0.1)',
              backgroundImage: `radial-gradient(#06080a, #f3f4f6)`,
            }}
            variants={{
              active: {
