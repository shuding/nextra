...
<Tabs items={['pnpm', 'npm', 'yarn']}>
  <Tabs.Tab>**pnpm**: Fast, disk space efficient package manager.</Tab>
  <Tabs.Tab>**npm** is a package manager for the JavaScript programming language.</Tab>
  <Tabs.Tab>**Yarn** is a software packaging system.</Tab>
</Tabs>
```
