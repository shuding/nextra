...
### Disable Image Zoom
For `docs-theme` and `blog-theme`, You can disable image zoom by replacing the `img` component used in MDX.

```jsx filename="theme.config.jsx"
// your other imports...
import { Image } from 'nextra/image'
...
When you globally disable image zoom but want to apply zoom to specific images, you can use it like this:
...
Or if you want to disable zoom for a specific image:
