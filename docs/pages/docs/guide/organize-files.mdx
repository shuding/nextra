...
That’s where `_meta.json` comes in. You can have a `_meta.json` file in each directory, and it will be used to override the default configuration of each page:
...
The extra configurations are passed to the theme as additional information of each page. Check the corresponding theme documentation for more information:
