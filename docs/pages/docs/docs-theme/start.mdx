...
### Static Export
Export your pages statically, and deploy with [Nginx](https://www.nginx.org/), [Github Pages](https://pages.github.com/) and more.
...
For more in detail documentation fo static export visit [Nextjs offical docs](https://nextjs.org/docs/pages/building-your-application/deploying/static-exports) .
</Steps>
