...
You can configure the `focusRing` option to determine whether to apply the
predefined focus ring styles.
...
<OptionTable
  options={[
    [
      'focusRing',
      'boolean',
      'Enable or disable the predefined focus ring style. Defaults to true.'
    ]
  ]}
/>
