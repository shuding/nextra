...
In addition, you can customize the sidebar title using the `sidebarTitle` property in your Frontmatter:

```md filename="pages/getting-started.mdx"
---
...
1. Frontmatter `title`
1. Filename of the page formatted with with [Title](https://title.sh) 
