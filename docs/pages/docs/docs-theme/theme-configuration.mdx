...
If `sidebar.autoCollapse` is set to true, all folders will automatically collapse to the level specified by `sidebar.defaultMenuCollapseLevel` unlesss the folder contains an active/focused route.
