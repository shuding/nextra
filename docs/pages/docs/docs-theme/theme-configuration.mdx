...
You can adjust the theme color of the website by setting primary hue and saturation values for light and dark themes.
...
<div className="flex h-6 items-center gap-2">
  <input
    ...
    onChange={e => {
      ...
      document.getElementById('test-theme-hue').innerText = hue + 'deg'
    }}
  />
  <code id="test-theme-hue" className="text-sm text-gray-500"></code>
</div>

<div className="mt-2">Saturation</div>
<div className="flex h-6 items-center gap-2">
  <input
    type="range"
    min="0"
    ...
    onChange={e => {
      ...
      document.getElementById('test-theme-saturation').innerText = saturation + '%'
    }}
  />
  <code id="test-theme-saturation" className="text-sm text-gray-500"></code>
</div>
