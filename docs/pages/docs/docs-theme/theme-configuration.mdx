...
<OptionTable options={[
  ['sidebar.defaultMenuCollapseLevel', 'number', 'Specifies the folder level at which the menu on the left is collapsed by default.'],
...
<div className="text-center text-sm mt-8">[Live example on StackBlitz ↗](https://stackblitz.com/edit/nextra-2-docs-8xbfk3?file=pages%2F_meta.json,theme.config.jsx)</div>
...
<div className="text-center text-sm mt-8">[Live example on StackBlitz ↗](https://stackblitz.com/edit/nextra-2-docs-yrlccm?file=theme.config.jsx)</div>
...
<OptionTable options={[
  ...
  ['search.emptyResult', 'React.ReactNode | React.FC', ''],
  ['search.placeholder', 'string | (() => string)', ''],
]}/>
