...
Those configurations affects the overall layout of the theme, espeically the navigation bar and the sidebar.
...
<div className="text-center text-sm mt-4">[Live example on StackBlitz ↗](https://stackblitz.com/edit/nextra-2-docs-eszspq?file=pages%2F_meta.json)</div>
...
<div className="text-center text-sm mt-8">[Live example on StackBlitz ↗](https://stackblitz.com/edit/nextra-2-docs-2qopvp?file=pages%2F_meta.json)</div>
...
The default one is sutiable for most cases like documentation, but you can use the `"article"` typesetting to make it look like an elegant article page:
...
<div className="text-center text-sm mt-4">[Live example on StackBlitz ↗](https://stackblitz.com/edit/nextra-2-docs-hg77h3?file=pages%2F_meta.json,pages%2Findex.mdx)</div>
