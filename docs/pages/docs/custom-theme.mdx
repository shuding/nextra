...
It accepts `children`, which is the MDX content of the current page, and wrapper some other elements.
You can simply create a MDX file as `pages/index.mdx` and see the result:
...
In your theme layout, you can use CSS imports or other ways to style it. Next.js hooks such as `useRouter`, `Head` are also available.
