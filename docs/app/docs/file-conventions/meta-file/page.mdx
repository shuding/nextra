...
|               |                               |                  |                                                                |
| ------------- | ----------------------------- | ---------------- | -------------------------------------------------------------- |
| `breadcrumb`  | `boolean{:ts}`                | `true`           | Show or hide breadcrumb navigation.                            |
| `collapsed`   | `boolean{:ts}`                | `false`          | Indicates whether the item in sidebar is collapsed by default. |
| `footer`      | `boolean{:ts}`                | `true`           | Specifies whether to display the footer.                       |
| `layout`      | `'default' \| 'full'{:ts}`    | `'default'{:ts}` | Defines the layout style.                                      |
| `navbar`      | `boolean{:ts}`                | `true`           | Specifies whether to display the navbar.                       |
| `pagination`  | `boolean{:ts}`                | `true`           | Determines if pagination controls are shown.                   |
| `sidebar`     | `boolean{:ts}`                | `true`           | Specifies whether to display the sidebar.                      |
| `timestamp`   | `boolean{:ts}`                | `true`           | Indicates if "last updated" timestamps are displayed.          |
| `toc`         | `boolean{:ts}`                | `true`           | Determines whether a table of contents is displayed.           |
| `typesetting` | `'default' \| 'article'{:ts}` | `'default'{:ts}` | Configures the text typesetting style.                         |
