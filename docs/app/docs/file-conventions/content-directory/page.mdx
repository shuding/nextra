...
### Set `contentDirBasePath` and `contentDirName` options in `next.config` file (_optional_)

If you want to serve your content at a different route or from a different 
path, you can set the `contentDirBasePath` and `contentDirName` options:
...
const withNextra = nextra({
  ...
  contentDirName: 'cms/markdown' // Nextra will look in the `/cms/markdown` and `/src/cms/markdown` folders for content.
})
```

If you want to serve your content at a different path, you can set
