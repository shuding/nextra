...
{/* <link rel="stylesheet"> is unsupported https://nextjs.org/docs/app/api-reference/functions/generate-metadata#unsupported-metadata */}
<link
  rel="stylesheet"
...
the browser. To enable LaTeX support, you must enable the `latex` option in your
...
>
> Alternatively, you can include `<link rel="stylesheet" />{:jsx}` directly in your MDX file.
>
...
However, KaTeX does not support all the features of MathJax, especially
