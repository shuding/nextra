...
| color.hue             | `number \| { dark: number; light: number }{:ts}` | The hue of the primary theme color.<br/>Default: `{ dark: 204, light: 212 }{:ts}`. (0 - 360) |
| color.saturation      | `number \| { dark: number; light: number }{:ts}` | The saturation of the primary theme color.<br/>Default: `100{:ts}`. (0 - 100)                |
| color.lightness       | `number \| { dark: number; light: number }`      | The lightness of the primary theme color. (0 - 100)                                          |
| backgroundColor.dark  | `"rgb(RRR,GGG,BBB)" \| "#RRGGBB"{:ts}`           | Background color for light theme.<br/>Default: `'rgb(17,17,17)'{:ts}`.                       |
| backgroundColor.light | `"rgb(RRR,GGG,BBB)" \| "#RRGGBB"{:ts}`           | Background color for dark theme.<br/>Default: `'rgb(250,250,250)'{:ts}`.                     |
