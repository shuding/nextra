...
[`page` file](https://nextjs.org/docs/app/api-reference/file-conventions/page) is a special
...
> [!TIP]
>
> By default, the `.js`, `.jsx`, or `.tsx` file extensions can be used for `page`.<br/>
