...
|             |                          |                                                                         |
| ----------- | ------------------------ | ----------------------------------------------------------------------- |
| logo        | `ReactNode{:ts}`         | Logo of the website. Default: `"Nextra - The Next Docs Builder"{:json}` |
| logoLink    | `boolean \| string{:ts}` | Link of the logo. Default: `true{:json}`                                |
| projectLink | `string{:ts}`            | URL of the project homepage                                             |
| projectIcon | `ReactNode{:ts}`         | Icon of the project link. Default: ` <GitHubIcon height="24" />{:ts}`   |
| chatLink    | `string{:ts}`            | URL of the chat link                                                    |
| chatIcon    | `ReactNode{:ts}`         | Icon of the chat link. Default: `<DiscordIcon width="24" />{:ts}`       |
...
<Screenshot full>![Project link](/assets/docs/project-link.png)</Screenshot>
