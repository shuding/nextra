...
|           |                      |     |                                                                   |
| --------- | -------------------- | --- | ----------------------------------------------------------------- |
| `pageMap` | `PageMapItem[]{:ts}` |     | Page map list. Result of `getPageMap(locale?: string){:ts}` call. |
...
|          |                  |     |                                                                                                  |
| -------- | ---------------- | --- | ------------------------------------------------------------------------------------------------ |
| `search` | `ReactNode{:ts}` |     | Rendered [`<Search>` component](/docs/built-ins/search). E.g. `<Search {...searchProps} />{:ts}` |
