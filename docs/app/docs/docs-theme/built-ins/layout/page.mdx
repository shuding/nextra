...
|                    |               |                                                                                               |
| ------------------ | ------------- | --------------------------------------------------------------------------------------------- |
| docsRepositoryBase | `string{:ts}` | URL of the documentation repository.<br/>Default: `'https://github.com/shuding/nextra'{:ts}`. |
...
|            |                |                                                                                                                                                                                                                                 |
| ---------- | -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| darkMode   | `boolean{:ts}` | Show or hide the dark mode select button. Default: `true{:ts}`                                                                                                                                                                  |
...
|          |                                       |                                                            |
| -------- | ------------------------------------- | ---------------------------------------------------------- |
| editLink | `string \| ReactElement \| null{:ts}` | Content of the edit link. Default: `'Edit this page'{:ts}`. |
...
|                  |                                       |                                                                                   |
| ---------------- | ------------------------------------- | --------------------------------------------------------------------------------- |
| feedback.content | `string \| ReactElement \| null{:ts}` | Content of the feedback link.<br/>Default: `'Question? Give us feedback'{:ts}`.    |
| feedback.labels  | `string{:ts}`                         | Labels that can be added to the new created issue.<br/>Default: `'feedback'{:ts}`. |
...
|                 |                          |                                                          |
| --------------- | ------------------------ | -------------------------------------------------------- |
| navigation      | `boolean \| object{:ts}` | Enable or disable navigation link. Default: `true{:ts}`. |
...
| sidebar.defaultMenuCollapseLevel | `number{:ts}`  | Specifies the folder level at which the menu on the left is collapsed by default. Default: `2{:ts}`. |
| sidebar.toggleButton             | `boolean{:ts}` | Hide/show sidebar toggle button. Default: `true{:ts}`.                                               |
...
|                  |                                       |                                                             |
| ---------------- | ------------------------------------- | ----------------------------------------------------------- |
| toc.backToTop    | `string \| ReactElement \| null{:ts}` | Text of back to top button. Default: `'Scroll to top'{:ts}`. |
| toc.extraContent | `string \| ReactElement \| null{:ts}` | Display extra content below the TOC content.                 |
| toc.float        | `boolean{:ts}`                        | Float the TOC next to the content. Default: `true{:ts}`.     |
| toc.title        | `string \| ReactElement \| null{:ts}` | Title of the TOC sidebar. Default: `'On This Page'{:ts}`.    |
