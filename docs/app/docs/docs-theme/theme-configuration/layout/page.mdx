...
The theme is configured with the `<Layout>` component. You should pass `props`
with your config options, for example:
...
|            |                |                                                                                                                                                                                                                                 |
| ---------- | -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| darkMode   | `boolean{:ts}` | Show or hide the dark mode toggle button. Default: `"true"{:json}`                                                                                                                                                              |
...
<Callout type="info">To disable it, you can set `editLink` to `null`.</Callout>
...
|                  |                                       |                                                                                            |
| ---------------- | ------------------------------------- | ------------------------------------------------------------------------------------------ |
| feedback.content | `string \| ReactElement \| null{:ts}` | Content of the feedback button.<br/>Default: `"Question? Give us feedback →"{:json}`       |
| feedback.labels  | `string{:ts}`                         | Labels that can be added to the new created GitHub issue.<br/>Default: `"feedback"{:json}` |
...
|                        |                       |                                                        |
| ---------------------- | --------------------- | ------------------------------------------------------ |
| i18n[number].direction | `"ltr" \| "rtl"{:ts}` | Writing direction of locale                            |
...
|             |                              |                                                                                |
| ----------- | ---------------------------- | ------------------------------------------------------------------------------ |
| lastUpdated | `React.FC<{ date: Date }>()` | Component to render the last updated info.<br/>Default: `<LastUpdated />{:js}` |
...
|             |                                                        |                                                                                                     |
| ----------- | ------------------------------------------------------ | --------------------------------------------------------------------------------------------------- |
| themeSwitch | `{ light: string; dark: string; system: string }{:ts}` | Options in the theme switch.<br/>Default: `{ light: 'Light', dark: 'Dark', system: 'System' }{:ts}` |
