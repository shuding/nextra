...
| logo                | `React.ReactNode \| React.FC{:ts}`              | Logo of the website                   |
| logoLink            | `boolean \| string{:ts}`                        | Link of the logo                      |
| project.link        | `string{:ts}`                                   | URL of the project homepage           |
| project.icon        | `React.ReactNode \| React.FC{:ts}`              | Icon or element of the project link   |
| chat.link           | `string{:ts}`                                   | URL of the chat link                  |
| chat.icon           | `React.ReactNode \| React.FC`                   | Icon or element of the chat link      |
| navbar.component    | `React.ReactNode \| React.FC<NavBarProps>{:ts}` | Navbar component                      |
