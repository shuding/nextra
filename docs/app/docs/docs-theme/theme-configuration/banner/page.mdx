...
|               |                  |                                                                                            |
| ------------- | ---------------- | ------------------------------------------------------------------------------------------ |
| `dismissible` | `boolean{:ts}`   | Closable banner or not. Default: `"true"{:json}`                                           |
| `key`         | `string{:ts}`    | Storage key to keep the banner state (dismissed or not). Default: `"nextra-banner"{:json}` |
...
```jsx filename="app/layout.jsx" {6-10}
