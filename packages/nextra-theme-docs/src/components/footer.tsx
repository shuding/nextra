...
export function Footer({ menu }: { menu?: boolean }): ReactElement {
  ...
  return (
    <footer className="_bg-gray-100 _pb-[env(safe-area-inset-bottom)] dark:_bg-neutral-900 print:_bg-transparent">
      <div
        className={cn(
          '_mx-auto _flex _max-w-[var(--nextra-content-width)] _gap-2 _py-2 _px-4',
      ...
      <div
        className={cn(
          '_mx-auto _flex _max-w-[var(--nextra-content-width)] _justify-center _py-12 _text-gray-600 dark:_text-gray-400 md:_justify-start',
