...
import { getNpxCommandOfPnpm, shouldUsePnpm } from './shouldUsePnpm'
...
async function run() {
  ...
  const sharedTemplate = path.resolve(__dirname, '../templates', `_shared_ts`)
  ...
  for (const pkgKey of ['dependencies', 'devDependencies']) {
