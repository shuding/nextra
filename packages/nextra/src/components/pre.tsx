...
export const Pre = ({
  ...
  return (
    <div className="nextra-code-block nx-relative nx-mt-6 first:nx-mt-0">
      ...
      <pre
        className={[
          'nx-bg-primary-700/5 nx-ring-1 nx-ring-primary-700/20 dark:nx-ring-primary-300/30 nx-mb-4 nx-overflow-x-auto nx-rounded-xl nx-font-medium nx-subpixel-antialiased dark:nx-bg-primary-300/10 nx-text-[.9em]',
