...
export default function Meta ({
  ...
  return <div className="meta-line">
    <div className="meta">
      {authorNode}
      ...
      {tags.map(t => {
        return <Link key={t} href="/tags/[tag]" as={`/tags/${t}`}><a className="tag">{t}</a></Link>
      })}
    </div>
    {back ? <Link href={back}><a className="meta-back">Back</a></Link> : null}
  </div>
}
