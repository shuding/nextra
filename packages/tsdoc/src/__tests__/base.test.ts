...
import { generateDefinitions } from '../../../nextra/src/server/tsdoc/base.js'
...
export default $`
    const result = generateDefinitions({ code })
...
export default $`
    const result = generateDefinitions({ code, flattened: true })
...
export default $`
    const result = generateDefinitions({ code })
    const result2 = generateDefinitions({
      code: code
