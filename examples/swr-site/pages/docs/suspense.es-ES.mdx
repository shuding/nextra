...
<Callout emoji="🚨" type="error">
  Suspense es actualmente una característica <strong>experimental</strong> de React. Estas APIs pueden cambiar significativamente y sin previo aviso antes de que se conviertan en parte de React.<br/>
