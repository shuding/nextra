...
大约两年前，我们[开源了](https://twitter.com/vercel/status/1188911002626097157) SWR，大家喜爱的小型数据请求 React 库。今天，我们迎来了另一个里程碑：SWR 1.0 版本发布！
...
我们还改进了 the bundling of the package，现在支持路径导入：
...
如果你没有使用 `useSWRInfinite`，它将不会包含在你的应用程序中。
